...
const Form = () => {
	...
	return (
		<Box className='grid lg:grid-cols-2 gap-4 p-4 shadow-lg lg:w-[70%] rounded-2xl h-fit'>
			...
			<Box className='lg:col-span-2 md:col-span-2 grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2  gap-2 bg-stone-100 p-5 rounded-lg'>
				<div className='lg:col-span-4 md:col-span-3 col-span-2'>
					<Typography color={colors.primary}>Pilih Catergori :</Typography>
				</div>
				...
				<Box className='grid lg:grid-cols-4 md:grid-cols-4 grid-cols-2 gap-2'>
					{imagePreview && imagePreview.length > 0 ? (
						...
						<Box className='lg:col-span-4 md:col-span-4 col-span-2 bg-white rounded-md shadow-xl relative overflow-hidden flex justify-center items-center p-2 w-full'>
							<Typography className='text-center text-slate-300'>Tidak Ada Gambar : <span className='text-error'>Gambar Minimal 1</span></Typography>
						</Box>
					)}
				</Box>
				<Button
