...
const Sidebar = () => {
    ...
    return (
        <div className={`${storeContext.activeSidebar ? `lg:md:w-[20vw] w-[70vw]` : `w-[0vw]`} h-screen shadow-xl lg:md:sticky fixed top-0 left-0 z-10 bg-white duration-500 ease overflow-hidden`}>
