  ...
  return (
    <div className="bg-white p-4 flex justify-between items-center shadow sticky top-0 text-primary z-40 w-full">
      <div className="flex gap-4 items-center">
        ...
        <IconButton onClick={handleWishlist} className="p-2">
          <FavoriteIcon fontSize={'large'} sx={{ color: 'red' }} />
        </IconButton>
        <IconButton onClick={handleCart} className="p-2">
          <ShoppingCartIcon fontSize={'large'} sx={{ color: 'green' }} />
        </IconButton>
      </div>
      <div className="flex gap-4">
        <IconButton
          ...
          onClick={handleClick}
        >
          <Avatar alt="Remy Sharp" src="/image/avatar/1.jpg" />
        </IconButton>
        <Menu
          id="basic-menu"
          anchorEl={anchorEl}
